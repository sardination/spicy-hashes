...
progs=(forkbomb/forkbomb_v1 forkbomb/forkbomb_v2 forkbomb/forkbomb_v3 forkbomb/forkbomb_v4 forkbomb/forkbomb_v5 forkbomb/benign_while mario/mario resize/resize resize/vigenere)
n=${#progs[@]}
